...
function test()
	...
	#
	chart2 = add_chart!(wb, Dict("type" => "bar", "subtype" => "stacked"))
	...
	#
	chart3 = add_chart!(wb, Dict("type" => "bar", "subtype" => "percent_stacked"))
